"""
amazon_loader_v2.py
A DataLoader that matches the specified IO contract and is compatible with Jenny's outputs.

Batch output:
{
  'user_features': {col: LongTensor[B_total], ...},
  'item_features': {col: LongTensor[B_total], ...},
  'text_features': FloatTensor[B_total, 768],
  'labels': LongTensor[B_total],          # 1 pos, 0 neg (online negative sampling)
  'ratings': FloatTensor[B_total],        # neg = 0
  # optional:
  # 'item_numeric': FloatTensor[B_total, F_item],     # Jenny’s part (optional)
  # 'user_profile_emb': FloatTensor[B_total, 768],    # Jenny’s part (optional)
}
"""
